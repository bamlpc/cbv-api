...
function scrollSpy() {
  var c = 5,
    ...
    l = (e && (e = window.getComputedStyle(e).scrollPaddingTop) &&
      "string" == typeof e && "auto" !== e && e.endsWith("px") &&
    ...
    o = debounce(function () {
      ...
      r !== i &&
        (r = d[i = r],
          ...
          t = s(
            r = r ? document.querySelector("#nav a[href*=" + r.id + "]") : null,
          ),
          n = (o = s(e)) !== t,
          o && n && u(o, !1),
          t && n && u(t, !0),
          r && (r.classList.add(l),
            r.scrollIntoViewIfNeeded
              ? r.scrollIntoViewIfNeeded()
              : !r.scrollIntoView ||
                0 <= (o = (o = r).getBoundingClientRect()).top && 0 <= o.left &&
                  o.bottom <=
                    (window.innerHeight ||
